...
import com.example.rangefinder_tradition.bluetoothdemo.thread.AcceptThread;
import com.example.rangefinder_tradition.bluetoothdemo.thread.ConnectedThread;

public class ServerActivity extends AppCompatActivity implements
        View.OnClickListener,
        AcceptThread.AcceptCallBack {
    ...
    //自己生成的uuid
    public static String uuidStr = "fa87c0d0-afac-11de-8a39-0800200c9a66";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_READ:
                    ...
                    currentString.setText(new String(buffer));
                    break;
            }
        }
    };
    ...
    private void openBlueTooth() {
        ...
        currentString.setText("AcceptThread监听中...");
        //作为server启动监听线程
                ...
                case BluetoothDevice.ACTION_BOND_STATE_CHANGED: {
                    ...
                    switch (device.getBondState()) {
                        case BluetoothDevice.BOND_NONE:
                            Log.i(TAG, "--- 配对失败 ---");
                            currentString.setText("配对失败");
                            break;
                        case BluetoothDevice.BOND_BONDING:
                            Log.i(TAG, "--- 配对中... ---");
                            currentString.setText("配对中... ");
                            break;
                        case BluetoothDevice.BOND_BONDED:
                            Log.i(TAG, "--- 配对成功 ---");
                            currentString.setText("配对成功");
                            break;
                    }
                    break;
                }
